<?php
    ...
    if($_SESSION['cart']['id_market'] != $_GET['market']){
        $_SESSION['cart']['item'] = array();
        $_SESSION['cart']['id_market'] = $_GET['market'];
        echo "<script>alert('Clean Success.');</script>" ;
    }
    ...
    // $_SESSION['cart']['id_market'] = $_GET['market'];
    // $_SESSION['cart']['item'] = array();
    array_push($_SESSION['cart']['item'],array('food' => $result,'form' => $form,'amount' => $amount));
    // array_push($_SESSION['cart'],array(3,'1'));
    // print_r($_GET);
    // echo '<br>';
    // print_r($_POST);
